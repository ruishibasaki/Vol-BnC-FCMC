...
public:
    ...
    void make_cutset(const std::vector<int> & s, std::deque<int> & ss_, std::deque<int> & ss_k, double &uss, double &dss, std::deque<int> & s_s, std::deque<int> & s_sk, double &us_s, double &ds_s);
